...
$idUser=$_SESSION['user_id'];
	...
	$selectCat = "SELECT `name`,`price`,`sale`,`img`,`quantities` FROM cart,products where cart.userId=$idUser and cart.prodId=products.prodId";
	$queryCat = $conn -> query($selectCat);
	foreach($queryCat as $cate){
                        ...
                        <tr class="table-row">
                            <td class="column-1">
                                <div class="cart-img-product b-rad-4 o-f-hidden">
                                    <img src="admin/images/<?= $cate['img'] ?>" alt="IMG-PRODUCT">
                                </div>
                            </td>
                            <td class="column-2"><?= $cate['name'] ?></td>
                            <td class="column-3"><?= $cate['price'] ?></td>
                            <td class="column-4">
                            ...
                            <td class="column-5"><?= $cate['quantities']*$cate['price'] ?></td>
                        </tr>
						<?php } ?>
