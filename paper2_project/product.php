...
<body class="animsition">
 ...
 ?>
                            <li class="p-t-4">
                                <a href="?cat_id=<?= $cate['id'] ?>" class="s-text13">
                                    <?= $cate['name'] ?>
                                </a>
                            </li>
                            <?php } ?>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                            ...
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                    <img src="admin/images/<?= $product['img'] ?>" alt="IMG-PRODUCT" height="300px">
                                    ...
                                    <div class="block2-overlay trans-0-4">
                                        ...
                                        <div class="block2-btn-addcart w-size1 trans-0-4">
                                            <!-- Button -->
                                            <a href="user/functions/cart/addToCart.php?id=<?= $product['prodId'] ?>" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
                                                Add to Cart
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="block2-txt p-t-20">
                                    <a href="product-detail.php?id=<?= $product['prodId'] ?>"
